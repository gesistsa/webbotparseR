...
attr(selectors_v2, "class") <- "webbot_selectors"

selectors_library$set("ver2", selectors_v2)


selectors_versions <- data.frame(version = c("ver1", "ver2"), snapshot_date = c(as.Date("2023-03-17"), as.Date("2024-03-24")))
